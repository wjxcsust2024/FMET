...
The main networks are Net,block, and wavelet_module. Since Mamba is used in the code, it is recommended to rent a server, set up a Pytorch environment under Linux, and download the necessary Python packages for the corresponding code.
